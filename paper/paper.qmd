...
Ontario in Canada. The analysis was conducted using both R (@citeR) and Python (@python),
...
contribution limits. The distribution of the average donation amount can be see in figure @fig-avg-donation.

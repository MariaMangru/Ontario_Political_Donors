...
contributions received by each party. 

To account for inflation and ensure comparability over time in the modeling process, the amount donated was adjusted using the Consumer Price Index (CPI), with 2024 set as the base year. This adjustment facilitated accurate regression analysis by normalizing donation amounts across different years. For the analysis section, which focuses on presenting either total or average donations, the unadjusted donation amounts were retained to provide a straightforward depiction of contribution figures.
...
donations, with a coefficient of 3.046 (standard error = 0.499, p \<
...
The In_Power variable has a coefficient of 0.886 (standard error =
0.547, p = 0.116), which is not statistically significant at the
...
(coefficient = 0.274, standard error = 0.449, p = 0.544), indicating
that donations are not substantially influenced by whether they occur
during an election year.

## Federal Results

At the federal level, Party_Size once again emerges as a significant determinant of total donations, with a coefficient of 3.452 (standard error = 0.259, p \< 0.001). This confirms that larger, more established parties are more successful at fundraising on the national stage, similar to the provincial setting.

The In_Power variable is not statistically significant in the federal model (coefficient = 0.637, standard error = 0.389, p = 0.103), implying that being the governing party at the federal level does not confer a clear advantage in terms of donation totals.

Similarly, Election_Year does not significantly impact federal donations (coefficient = -0.042, standard error = 0.221, p = 0.849), indicating no substantial change in donor behavior during election years at the federal level.

## Conservative/Liberal Results

In the Conservative/Liberal model, the In_Power variable is now positively and significantly related to total donations (coefficient = 1.201, standard error = 0.513, p = 0.022), while the interaction In_Power × Party is significantly negative (coefficient = -1.711, standard error = 0.734, p = 0.023). This interaction means that the effect of being in power depends on whether the party is Conservative or Liberal.

For the Conservative Party (Party = 1), the combined effect of being in power is approximately 1.201 + (-1.711) = -0.510, suggesting that being in power is associated with lower total donations for the Conservative Party. For the Liberal Party (Party = 0), the effect of being in power remains 1.201, indicating that being in power is linked to higher donation totals for the Liberal Party.

The Party variable itself is also significant (coefficient = 1.364, standard error = 0.513, p = 0.0099), indicating that, when not considering the interaction, the Conservative Party tends to attract more donations than the Liberal Party. The Election_Year variable remains non-significant (coefficient = -0.023, standard error = 0.390, p = 0.953), suggesting no direct election-year influence on donations within this subset.
...
@fig-estimates continues to highlight the consistently strong positive effect of Party_Size on total donations in both the Ontario and Federal models, affirming that well-established parties attract more donor support. It also illustrates the significant interaction effect between In_Power and Party in the Conservative/Liberal model, demonstrating that the influence of being in power on donations differs notably between the two major parties.

In summary, the updated results show that party size consistently drives higher donations across jurisdictions, while the impact of being in power on donation amounts depends on the party’s ideological affiliation, especially when contrasting Conservative and Liberal parties.

# Discussion {#sec-discussion}

## Financial Influence Shapes Political Landscapes

At the heart of politics is finance, as revealed by Traag’s research on
the complex contagion of campaign donations in the United States
[@traag2016complex]. Traag’s study found that most campaign
contributions come from a small number of wealthy donors linked by large
social networks, demonstrating how a few individuals can shape political
outcomes. Similar dynamics appear to be at play in Canada. Here, donors
often prefer to support parties not currently in power. One reason might
be the hope that challengers will bring needed policy changes. More
realistically, as noted by Mollona [@mollona2022ethics], politicians,
especially those out of power, often seek funding in exchange for
promoting donors’ interests. Over time, this can lead to a pattern where
donors shift their support to whoever best serves their goals, fostering
continuous political competition. A key finding of this study is that at
both the Ontario and federal levels, the Conservative Party generally
attracts more financial backing than other parties. This steady flow of
resources may help the Conservatives maintain a strong presence in the
political arena, influencing agenda-setting and public debate. With more
funds, they can more easily finance voter outreach, shape their
messaging, and solidify their support networks. While this financial
advantage may help sustain dynamic election contests, it also
underscores concerns about whose interests gain the most traction. When
one party consistently out-raises others, the policy conversation may
lean toward those who provide the most money, potentially sidelining
issues important to groups with fewer financial resources.

## International Comparisons and the Importance of Regulation

These trends are not confined to Canada. In the United Kingdom, for
example, large private donations, often from very wealthy “superdonors”,
widen the gap between major parties and smaller competitors
[@draca2022financing]. Such patterns highlight a broader democratic
challenge, as money can concentrate power and influence political
direction in ways that may not always reflect broad public preferences.
Rather than serving purely as a resource that encourages healthy
competition, political donations can also become a tool that benefits
certain parties and voices more than others. Regulation and transparency
are essential. Clearer rules and better public reporting help citizens
understand who funds whom and why. Drawing lessons from other countries
may guide reforms aimed at limiting undue influence. Stronger oversight,
spending caps, and easy-to-access donor databases can empower voters to
make informed choices. Without these safeguards, the already powerful,
whether individuals, industries, or interest groups, can gain even more
sway, risking an erosion of trust in democratic institutions.
...
This would enhance the generalizability of the results and provide a
...
## Appendix C: Idealized Methodology
...
-   Sampling and Recruitment: \$15,000
    ...
    -   Expenses related to accessing online panel respondents,
        purchasing targeted advertising on social media, and
        collaborating with panel providers. Funds also cover the
        services of statisticians to ensure the sampling aligns with the
        population distribution.

-   Respondent Incentives: \$20,000

    -   Allocated for compensating participants with \$10 electronic
        gift cards or funding the national sweepstakes prizes.
        Incentives are crucial for improving response rates and
        attracting a diverse respondent pool.

-   Data Collection: \$25,000

    -   Operational costs for administering the survey, including online
        platform fees, telephone survey expenses, interviewer training,
        and call center operations. This ensures data collection is
        efficient and reaches a broad audience.

-   Data Analysis and Reporting: \$12,000

    -   Funds dedicated to analyzing the collected data, including
        hiring data analysts proficient in statistical software,
        conducting comprehensive analyses, and preparing detailed
        reports and visualizations to communicate findings effectively.

-   Ethical Compliance and Data Security: \$5,000

    -   Covers the costs of obtaining ethical approvals, ensuring
        compliance with privacy legislation (e.g., Personal Information
        Protection and Electronic Documents Act), and implementing
        robust data security measures to protect respondent information.
...
population. The survey can be accessed using [this
...
Thank you for participating in this important survey. Your responses
will help us understand how Canadians make decisions about donating to
political parties at both the federal and Ontario provincial levels. By
sharing your perspectives, you will contribute to a deeper understanding
of what motivates political donations, what factors shape donor
decisions, and how parties can improve their engagement with supporters.
Your answers are completely confidential and will be used solely for
research purposes.
...
Average Annual Donation Amount (to all political parties combined):
...
Preferred Donation Channels: (Select all that apply)

-   Online platforms (e.g., party websites, crowdfunding sites)

-   Mail-in donations

-   In-person events (e.g., fundraisers, rallies)
...
-   Personal connection to a candidate
...
-   Party’s track record and past performance

-   Recommendations from peers, family, or community leaders

-   Media coverage and public opinion polls

-   Urgency or importance of the upcoming election

-   Other (please specify)

**Section 4: Impact of Campaigns and Events**

-   Have recent political events (e.g., elections, leadership changes,
    policy announcements) influenced your donation behavior?

    -   Yes

    -   No

    If yes, please specify the event(s) and how they influenced your
    donations:\
    *(Open-ended)*
...
-   Have you ever stopped donating or reduced donations because of a
    party’s perceived performance or power status (e.g., losing seats,
    scandals)?

    -   Yes (please explain why) *(Open-ended)*

    -   No

**Section 5: Feedback and Suggestions**

-   In your opinion, what could political parties do to encourage more
...
**Thank you for participating!** Your feedback is valuable and will help
researchers and political parties understand the dynamics of political
giving in Canada. Your insights contribute to more informed policies and
practices, ultimately shaping a more responsive and transparent
political landscape.

...
A key question in political finance is whether a party's position in power affects the amount of financial support it receives. Studies in other countries, such as the  @fouirnaies2014financial conducted in the United States, have shown that incumbents often benefit from more donations, particularly from interest groups seeking to maintain influence. However, there has been less focus on whether this holds true in Canada, where the political system and donation regulations differ significantly. This paper aims to fill that gap by analyzing how a party's power status influences donor behaviour in federal and Ontario provincial elections.
